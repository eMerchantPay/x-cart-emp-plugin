{**
 * emerchantpayDirect Payment Template
 *
                ...
                <div class="form-wrapper">
                  <div class="form-group active">
                      <input autocomplete="off"
                             ...
                             name="emerchantpay-direct-card-number">
                      <input autocomplete="off"
                             placeholder="Card holder"
                             title="Card holder"
                             class="form-control field-required" type="text"
                             name="emerchantpay-direct-card-holder">
                      <input autocomplete="off"
                             placeholder="CVV / CVV2 / CSC"
                             title="CVV / CVV2 / CSC"
                             class="form-control card-cvv field-required" type="text"
                             name="emerchantpay-direct-card-cvc">
                      <input autocomplete="off"
                             ...
                             name="emerchantpay-direct-card-expiry">
                  </div>
                </div>
              </div>
